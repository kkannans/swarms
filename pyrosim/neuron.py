...
class NEURON: 
    ...
    def Update_Sensor_Neuron(self, value = None):
        if value == None:
    ...
    def Allow_Presynaptic_Neuron_To_Influence_Me(self, synaptic_weight, presynapse_value):
        self.Add_To_Value(synaptic_weight*presynapse_value)
